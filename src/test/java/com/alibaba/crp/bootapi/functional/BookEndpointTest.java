...
package com.alibaba.crp.bootapi.functional;
...
import com.alibaba.crp.bootapi.util.JsonMapper;
...
import com.alibaba.crp.bootapi.api.support.ErrorResult;
import com.alibaba.crp.bootapi.domain.Book;
import com.alibaba.crp.bootapi.dto.BookDto;
import com.alibaba.crp.bootapi.repository.BookDao;
import com.alibaba.crp.bootapi.service.exception.ErrorCode;


import com.google.common.collect.Maps;
import com.alibaba.crp.bootapi.util.RandomData;
...
public class BookEndpointTest extends BaseFunctionalTest {
	...
	public void listBook() {
		...
		assertThat(firstBook.owner.name).isEqualTo("User1");

		BookDto book = restTemplate.getForObject(resourceUrl + "/{id}", BookDto.class, 1L);
		assertThat(book.title).isEqualTo("Big Data日知录");
		assertThat(book.owner.name).isEqualTo("User1");
	}

	@Test
	public void applyRequest() {
		String token = login("user1@gmail.com");
	...
	public void fullBorrowProcess() {
		// 发起请求
		String token = login("user2@gmail.com");
